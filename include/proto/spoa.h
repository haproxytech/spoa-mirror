 ...
 */
#ifndef _PROTO_SPOA_H
#define _PROTO_SPOA_H

int acc_payload(struct spoe_frame *frame);
void read_frame_cb(struct ev_loop *loop, ev_io *ev, int revents);
void write_frame_cb(struct ev_loop *loop, ev_io *ev, int revents);
